      ...
      <footer className="text-white bg-[#5BA1E5]">
        <div className="flex flex-col justify-between lg:flex-row gap-24 items-start lg:items-center container mx-auto py-36 md:py-60 px-5">
          <div className="font-mono">
            ...
            <a href="mailto:info@spid.com.hr">
              <p className="font-semibold text-3xl sm:text-5xl">INFO@SPID.COM.HR</p>
            </a>
          </div>
          <div className="md:text-lg basis-1/4">
            <h4 className="font-bold text-xl">Telefon</h4>
            <a href="tel:+385976362743">
              <p className=" mb-10">+385 97 63 62 743</p>
            </a>
            <h4 className="font-bold text-xl">Adresa</h4>
            <p>Savez Scenarista i pisaca izvedbenih djela, Tratinska 53/2, 10000 Zagreb</p>
          </div>
        </div>
        <div className="border-y-2 my-7">
          <div className="container mx-auto flex flex-col lg:flex-row justify-between px-5 text-sm">
            <p className="py-4">OIB | 51227446526</p>
            <div className="border-l-2"></div>
            <p className="py-4">MB | 04441451</p>
            <div className="border-l-2"></div>
            <p className="py-4">IBAN | HR3223400091110749078</p>
            <div className="border-l-2"></div>
            <p className="py-4">RNO | 0342550</p>
            <div className="border-l-2"></div>
            <p className="py-4">Broj u Registru udruga | 21011676</p>
          </div>
        </div>
        <div className="container mx-auto flex flex-row items-center justify-between gap-6 py-7 px-5">
          <p className=" text-xs sm:text-sm">Rad strukovne udruge SPID podržavaju Hrvatski audiovizualni centar i Ministarstvo kulture i medija Republike Hrvatske.</p>
